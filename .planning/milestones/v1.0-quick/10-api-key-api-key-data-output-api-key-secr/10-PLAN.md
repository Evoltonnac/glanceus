...
depends_on: []
files_modified:
  - .planning/milestones/v1.0-quick/10-api-key-api-key-data-output-api-key-secr/10-SUMMARY.md
  - .planning/STATE.md
autonomous: true
requirements: []
---
...
<task type="auto">
  ...
  <files>.planning/milestones/v1.0-quick/10-api-key-api-key-data-output-api-key-secr/10-SUMMARY.md</files>
  <action>
...
<output>
After completion, create .planning/milestones/v1.0-quick/10-api-key-api-key-data-output-api-key-secr/10-SUMMARY.md
</output>
