...
files_modified:
  ...
  - skills/README.md
  - .planning/milestones/v1.0-quick/11-skills-prompt-ai-prompt-github-skills/11-SUMMARY.md
  - .planning/STATE.md
autonomous: true
requirements: []
---
...
<task type="auto">
  ...
  <files>skills/README.md, .planning/milestones/v1.0-quick/11-skills-prompt-ai-prompt-github-skills/11-SUMMARY.md, .planning/STATE.md</files>
  <action>
...
<output>
After completion, create .planning/milestones/v1.0-quick/11-skills-prompt-ai-prompt-github-skills/11-SUMMARY.md
</output>
