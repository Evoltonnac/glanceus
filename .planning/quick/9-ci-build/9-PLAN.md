...
<task type="auto">
  ...
  <files>ui-react/src-tauri/src/lib.rs, README.md, docs/build-path-contract.md, .planning/quick/9-ci-build/9-SUMMARY.md, .planning/STATE.md</files>
  <action>
...
<output>
After completion, create .planning/quick/9-ci-build/9-SUMMARY.md
</output>
